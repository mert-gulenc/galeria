...
export type GaleriaIndexChangedEvent = NativeSyntheticEvent<GaleriaIndexChangedPayload>;
export type GaleriaLongPressEvent = NativeSyntheticEvent<Record<string, never>>;
export type GaleriaRightNavItemPressedEvent = NativeSyntheticEvent<{
    index: number;
}>;
export type GaleriaDismissEvent = NativeSyntheticEvent<Record<string, never>>;
export interface GaleriaHeaderMenuItem {
    id: string;
    label: string;
    icon?: string;
...
export interface GaleriaHeaderItem {
    id: string;
    icon: string;
    label?: string;
    isMenu?: boolean;
...
type GaleriaHeaderActionPayload = {
    buttonId: string;
    menuItemId?: string;
    currentIndex: number;
};
export type GaleriaHeaderActionEvent = NativeSyntheticEvent<GaleriaHeaderActionPayload>;
